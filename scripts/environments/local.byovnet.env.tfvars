...
workspace="myworkspace" # Required
subscription_id="" # Required

# ----------------------------------------------------------
# Modification for the deployment of the Information Assistant
# This bring your own VNET and subnet and deploy OPENAI in a different region
# ----------------------------------------------------------
#Bring your own VNET and Subnet (Spoke)
BRING_YOUR_OWN_VNET=true

# The resource group that contains your virtual network
spoke_resource_group_name="rg-spoke"

# The resource group that contains the resources for the Information Assistant
# can be the same resource group than the spoke or a different one
RESOURCES_RESOURCE_GROUP_NAME="rg-ai-resources"

# The region where OpenAI will be deployed
OPENAI_REGION="canadaeast"
...
REQUIRE_WEBSITE_SECURITY_MEMBERSHIP=false # Required
...
SECRET_EXPIRATION_DAYS=730 # Required
...
USE_EXISTING_AOAI=false # Required
...
USE_AZURE_OPENAI_EMBEDDINGS=true # Required
...
# OPEN_SOURCE_EMBEDDING_MODEL="BAAI/bge-small-en-v1.5"
# OPEN_SOURCE_EMBEDDING_MODEL_VECTOR_SIZE="384"

# Uncomment and set the desired model and vector size:
# OPEN_SOURCE_EMBEDDING_MODEL="sentence-transformers/all-mpnet-base-v2"
# OPEN_SOURCE_EMBEDDING_MODEL_VECTOR_SIZE="768"

# Uncomment and set the desired model and vector size:
# OPEN_SOURCE_EMBEDDING_MODEL="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"
# OPEN_SOURCE_EMBEDDING_MODEL_VECTOR_SIZE="384"
...
DEFAULT_LANGUAGE="en-US" # Required
...
MAX_CSV_FILE_SIZE="20" #default is 20MB
